...
## Neutron Stars and Black Hole Dynamics
...
[image-center](../assets/images/cc_noncc_2dproj.png){: .align-center}{:style="border: 1px solid black; padding: 10px"}{:height="30%" width="30%"}
...
## Millisecond Pulsars in Observations
